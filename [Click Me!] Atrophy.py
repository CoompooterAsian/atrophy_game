...
# Classes
    ...
    while not done:
        ...
        if stage == PLAYING:
            ...
            if clock_ticks % 60 == 0:
                organ_timer -= 1
            pygame.draw.rect(screen, organ_timer_color,[rect.centerx - (((organ_timer/50)*1000)/2),HEIGHT - 85,(organ_timer/50)*1000,5])
